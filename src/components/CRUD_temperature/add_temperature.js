...
class AddTemperature extends React.Component {  
  constructor(props) {  
    super(props);  
    ...
    if (props.temperature.temperatureId) {  
      this.state = props.temperature;
        ...
        <Row>  
          <Col sm={7}>  
            <Form onSubmit={this.handleSubmit}>  
              ...
              <Form.Group>  
                <Form.Control type="hidden" name="temperatureId" value={this.state.temperatureId} />  
